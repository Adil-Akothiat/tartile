    ...
    return (
        <div className="features main-width my-grid">
            ...
            >
                <RiFilePaper2Fill />
                <h3>دورات متعددة</h3>
                <p>نمكنك من أن تصبح مرتلا من خلال دورات حفظ سور القرآن الكريم مع التفسير وقواعد التجويد، أحكاماً وتطبيقات، ودورات لتعلم اللغة العربية وتدريب النطق الصحيح.</p>
            </div>
            <div
                data-aos="fade-up"
                data-aos-delay="50"
